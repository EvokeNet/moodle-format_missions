// Javascript functions for Missions course format
    ...
    if (response.action == 'move') {
        ...
        for (var i = sectionfrom; i <= sectionto; i++) {
            ...
            var content = Y.Node.create(
                '<span>' + response.sectiontitles[i] + '</span>'
            );
            sectionlist
                .item(i)
                .all('.' + CSS.SECTIONNAME)
            ...
            ele = sectionlist
                .item(i)
                .one(SELECTORS.SECTIONLEFTSIDE)
                .ancestor('.section-handle');
            ...
            sectionlist
                .item(i)
                .setAttribute('aria-label', content.get('innerText').trim());
