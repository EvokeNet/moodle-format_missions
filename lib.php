 ...
 */
class format_missions extends format_base
{
    ...
    public function inplace_editable_render_section_name(
        ...
        if (empty($edithint)) {
            $edithint = new lang_string('editsectionname', 'format_missions');
        }
        if (empty($editlabel)) {
            $title = get_section_name($section->course, $section);
            $editlabel = new lang_string('newsectionname', 'format_missions', $title);
        }
 ...
 * @return \core\output\inplace_editable
 */
function format_missions_inplace_editable($itemtype, $itemid, $newvalue)
{
    global $DB, $CFG;
    require_once($CFG->dirroot . '/course/lib.php');
